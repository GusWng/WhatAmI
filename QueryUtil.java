...
public final class QueryUtil {
    ...
    /**
     * Return a list of {@link QuakeClass} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<QuakeClass> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<QuakeClass> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i=0; i<features.length(); i++){
                ...
                QuakeClass newItem = new QuakeClass(mag,place,time);

                //Add earthquake to list of earthquakes
                earthquakes.add(newItem);
